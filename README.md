* Last stable version (0.10): [![Build Status](https://ci.inria.fr/pharo-contribution/buildStatus/icon?job=Kendrick/PHARO=30,VERSION=stable,VM=vm)](https://ci.inria.fr/pharo-contribution/job/Kendrick/PHARO=30,VERSION=stable,VM=vm/)
...
Gofer new
    ...
    load.
((Smalltalk at: #ConfigurationOfKendrick) project version: '0.10') load.
````
